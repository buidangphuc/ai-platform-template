...
from app.modules.objects.gateway import ObjectGateway
...
class ObjectAddon:
    ...
    async def open(
        ...
        attach_app_resource(app, resources, "objects", build_object_gateway(settings))

    async def close(self, app: FastAPI, resources: ApplicationResources) -> None:
        objects = optional_app_resource(app, "objects")
